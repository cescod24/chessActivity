...
function logicManager(initialSquare, x, y, extra) {
    ...
    if ((currentPos[targetSquare_y][targetSquare_x] == "/" && !justEnpassanted) && !isInCheck()) {
        ...
        console.log(currentPos, currentToIndex, piecesSprites)

        return
    }

    if ((selectedPieceColor != targetedPieceColor || justEnpassanted) && !isInCheck()) {
